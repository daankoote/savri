...
- Signup payload mapper, local-only contract dry-run proof, and unused frontend API client are implemented and locally proven, but `/app` submit wiring remains blocked until explicit UI wiring is approved.
