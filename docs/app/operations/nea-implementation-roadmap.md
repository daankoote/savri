...
Next bounded gates: WP3D is committed and WP3E internal location decisions 1–16 are approved TARGET. Resolve the remaining location source/evidence/privacy/retention/mapping blockers and prepare a separately approved exact replacement contract before any location DDL-readiness step; connection DDL remains dependent on a proven locationfoundation. Independently obtain written Dutch corporate-law and external-verifier validation of the representation-authority pilot brief and resolve the connection/EAN external blockers. None of these gates authorizes schema work.
...
| Current work package | WP3E registers Daan's approval of internal location decisions `WP3E-LOC-01`–`WP3E-LOC-16` as TARGET — DOCS ONLY; WP3D is locally committed in HEAD `88e8c0b754c7d44e769f89037676d9732e6fe63c`; no implementation, proof, DDL, data migration, cutover or retirement is authorized |
| Last completed work package | WP3D — location current-truth readiness audit and bounded draft contract — DOCS ONLY — COMMITTED |
| Next executable work package | Attributable external/source validation, 44-row mapping design and a separately approved exact replacement contract — DOCS ONLY; a limited connection-root/claim DDL-readiness assessment remains blocked until locationfoundation implementation and proof |
| Current blockers | PDOK/BAG source contract/freshness; reliable physical-site matching; verifier acceptance of location evidence; DSO/CAR semantics; primary/secondary/MLOEA; location-visit procedure/evidence; evidence categories/acceptance; privacy/minimization; retention beyond the explicit TKV minimum; mapping of all 44 current rows; remote catalog/caller truth. Connection remains location-dependent. Authority validation is independent and representation authority is NOT SCHEMA READY |
...
| Evidence reference | WP2B-I commit `5a5265adc516e8198cc25757654920d4aa3316bd`; authority brief commit `d44379f52125370eb91b0de52098a1df69bd2f92`; WP3A commit `f3b39aafb2e6817e64401ccb2c47eed285552869`; WP3B commit `ee3f6b59c937f0c39a67ba09936e9ef688bcea59`; WP3C commit `da961fa84da73ecc320b55b2cb83881a12d658f3`; WP3D HEAD `88e8c0b754c7d44e769f89037676d9732e6fe63c`; `operations/wp3e-location-internal-domain-decisions.md`; `contracts/location-foundation.md`; official TKV snapshot and mapped requirements |
...
| 3 | Location, connection/EAN and validity periods | Complete location/connection truth, temporal facts, aangeslotene claims, and safe review/read boundaries. | IN PROGRESS | NEA-EAN; NEA-AUD-002; NEA-SEC-001/002 | Legal-party connection truth is separate from account, case role, authority, mandate, location, charger/MID and kWh; TKV-aligned internal controls do not establish regulatory acceptance. | Hybrid | Committed WP3A-WP3D evidence; WP2 party/case boundaries; approved WP3C/WP3E internal TARGET; later accepted source/evidence decisions | WP3E approves stable statusless root, immutable accepted versions/observations, temporal/supersession/link/security/replacement semantics; no schema or runtime module approved | Current location has 44 mutable dossier-bound rows and live signup/dashboard/charger/document dependencies; forward-only replacement needs exact mapping and proof; no mutation performed | Future proof must cover no mutable root address, no observation acceptance, correction/relocation/split-merge, one operational version, intervals/overlap, supersession/cycles, concurrency, no browser grants/no inference and 44-row protected history | WP3D HEAD `88e8c0b754c7d44e769f89037676d9732e6fe63c`; `operations/wp3e-location-internal-domain-decisions.md`; `contracts/location-foundation.md`; proofs not run | Resolve open location external/source/mapping blockers and approve an exact replacement contract; do not start DDL, proof, cutover or retirement. Connection DDL waits for proven locationfoundation. |
...
| Internal after GO | locations | IN PROGRESS | WP3D current-truth evidence is committed; WP3E approves internal root/version/observation/correction/relocation/split-merge/link/security/replacement TARGET only. External blockers, exact replacement contract, implementation, proof, mapping, DDL, migration and retirement remain open or unauthorized. |
...
WP3C records Daan's approved connection/EAN internal TARGET, and WP3D is
committed in HEAD `88e8c0b754c7d44e769f89037676d9732e6fe63c`. WP3E
records Daan's approval of location decisions `WP3E-LOC-01` through
`WP3E-LOC-16` as TARGET only. The TKV alignment guard is recorded: internal
roots, immutable versions, RLS and grants support reconstruction but establish
no TKV or verifier acceptance. Implementation, proof, DDL, data migration,
caller cutover and retirement remain unauthorized; external/source/mapping
blockers remain open. Connection DDL still depends on a proven
locationfoundation. Authority validation continues externally and
independently.

| checklist item | status | evidence / gate |
|---|---|---|
| design/contract | COMPLETE — UNCOMMITTED | WP3E adds `operations/wp3e-location-internal-domain-decisions.md` and updates the location contract to exact approved-TARGET/non-DDL status for decisions 1–16; candidate physical names remain unapproved. |
| existing module inventory | COMPLETE — CURRENT PROVEN | Committed WP3D read-only evidence records current migration provenance, 44 location rows, inbound charger/document/connection FKs, signup write, dashboard read, Auth boundary, PDOK observation, legacy source material, proofs and hashes. |
...
| database | BLOCKED — EXTERNAL | `app_dossier_locations` remains mutable, dossier-bound and populated. WP3E authorizes no DDL, row mutation, mapping execution, migration-history write, cutover or retirement; exact replacement contract, external answers, 44-row mapping/proof and later execution approval are required. |
...
| tests | TODO | Future proof must cover the WP3E minimum scenarios after separate exact-contract and implementation authorization. No proof was run in WP3E. |
| SQL proof | NOT APPLICABLE | WP3E is docs only. No SQL, proof script, database query or migration ran. |
| browser proof | TODO | Required only when approved customer-visible behavior is implemented. |
| documentation update | COMPLETE — UNCOMMITTED | One new WP3E decision record plus bounded contract, architecture, traceability, roadmap, TODO and append-only changelog updates; WP3D audit, WP3C record, protected docs, code and schema remain unchanged. |
| accepted by Daan | TARGET | Internal location package 1–16 is approved TARGET. External answers, exact physical replacement contract, DDL, implementation, proof, data migration, cutover, retirement and execution are not approved. |
