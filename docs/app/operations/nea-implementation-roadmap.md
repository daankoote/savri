...
| 3 | Location, connection/EAN and validity periods | Complete location/connection truth, temporal facts, aangeslotene claims, and safe review/read boundaries. | BLOCKED — DECISION | NEA-EAN; NEA-AUD-002; NEA-SEC-001/002 | Legal-party connection truth is separate from account, case role, authority, mandate, location, charger/MID and kWh; CAR/DSO truth remains external. | Hybrid | Committed WP3A current-truth audit; WP3B draft contract/disposition; WP2 party/case boundaries; location and later accepted evidence/source decisions | Docs-only contract/disposition complete; no schema or runtime module approved | Three current empty tables, eight guards, nine triggers, one audithelper and four RPCs are dispositioned for replacement; no mutation performed | No CURRENT PROVEN connection proof; both existing proof files are `PROVE AGAIN` after approval and must add contract-driven concurrency/history evidence | WP3A commit `f3b39aafb2e6817e64401ccb2c47eed285552869`; `contracts/connection-ean-and-aangeslotene.md`; `operations/wp3b-connection-ean-object-disposition.md`; proofs not rerun | Obtain Daan's explicit WP3B decisions and resolve applicable location/external evidence blockers; do not start read projection or DDL. |
