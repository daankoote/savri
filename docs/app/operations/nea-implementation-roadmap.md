...
Next bounded gates: WP3E is committed in HEAD `e04f4a695d983c71a52f48d0c3c26ca605bb4402`. WP3F proves that the location DDL design is not safe: all 44 privacy-safe aliases require manual duplicate review, no row may be promoted automatically, and all ten candidate DDL responsibilities remain blocked. Prepare a separately approved exact physical replacement contract before any location DDL, population, cutover or proof implementation; connection DDL remains dependent on a proven locationfoundation. Independently obtain written Dutch corporate-law and external-verifier validation of the representation-authority pilot brief and resolve the connection/EAN external blockers. None of these gates authorizes schema work.
...
| Current work package | WP3F documents a read-only location DDL-readiness and privacy-safe 44-row classification audit; verdict `BLOCKED — LOCATION DDL DESIGN NOT SAFE`; no implementation, DDL, data migration, cutover or retirement is authorized |
| Last completed work package | WP3E — internal location decisions 1–16 — DOCS ONLY — COMMITTED in HEAD `e04f4a695d983c71a52f48d0c3c26ca605bb4402` |
| Next executable work package | Exact physical location replacement-contract decision — DOCS ONLY, including columns/types/defaults, accepted-version representation, observation privacy/retention/provenance, deterministic concurrency, policies/grants/RPCs and proof matrix; no DDL |
| Current blockers | All 44 current rows are `POSSIBLE_DUPLICATE`, require manual review and have automatic promotion `NO`; exact physical schema, accepted-version representation, observation privacy/retention/provenance, deterministic lock/transaction-end enforcement, policies/grants/RPCs and cutover proof remain undecided. PDOK/BAG, verifier, DSO/CAR, primary/secondary/MLOEA and remote truth remain open. Connection remains location-dependent. Authority validation is independent and representation authority is NOT SCHEMA READY |
...
| Evidence reference | WP2B-I commit `5a5265adc516e8198cc25757654920d4aa3316bd`; authority brief commit `d44379f52125370eb91b0de52098a1df69bd2f92`; WP3A commit `f3b39aafb2e6817e64401ccb2c47eed285552869`; WP3B commit `ee3f6b59c937f0c39a67ba09936e9ef688bcea59`; WP3C commit `da961fa84da73ecc320b55b2cb83881a12d658f3`; WP3D commit `88e8c0b754c7d44e769f89037676d9732e6fe63c`; WP3E HEAD `e04f4a695d983c71a52f48d0c3c26ca605bb4402`; `operations/wp3f-location-ddl-readiness-audit.md`; `operations/wp3f-location-44-row-classification.md`; official TKV snapshot and mapped requirements |
...
| 3 | Location, connection/EAN and validity periods | Complete location/connection truth, temporal facts, aangeslotene claims, and safe review/read boundaries. | IN PROGRESS | NEA-EAN; NEA-AUD-002; NEA-SEC-001/002 | Legal-party connection truth is separate from account, case role, authority, mandate, location, charger/MID and kWh; TKV-aligned internal controls do not establish regulatory acceptance. | Hybrid | Committed WP3A-WP3E evidence; WP2 party/case boundaries; approved WP3C/WP3E internal TARGET; later accepted source/evidence decisions | WP3E approves stable statusless root, immutable accepted versions/observations, temporal/supersession/link/security/replacement semantics; WP3F finds all ten candidate DDL responsibilities blocked | Current location has 44 mutable dossier-bound rows and live signup/dashboard/charger/document dependencies; WP3F classifies 44/44 as `POSSIBLE_DUPLICATE`, manual review `YES`, automatic promotion `NO`; no mutation performed | Future proof must cover no mutable root address, no observation acceptance, correction/relocation/split-merge, one operational version, intervals/overlap, supersession/cycles, deterministic concurrency, no browser grants/no inference and 44-row protected history | WP3E HEAD `e04f4a695d983c71a52f48d0c3c26ca605bb4402`; `operations/wp3f-location-ddl-readiness-audit.md`; `operations/wp3f-location-44-row-classification.md`; read-only local SQL only | Approve an exact physical replacement contract in a separate docs-only decision; do not start DDL, population, proof implementation, cutover or retirement. Connection DDL waits for proven locationfoundation. |
...
| Internal after GO | locations | IN PROGRESS | WP3E is committed. WP3F classifies all 44 rows as possible duplicates requiring manual review and blocks all ten candidate DDL responsibilities. Exact replacement contract, implementation, proof, mapping decisions, DDL, migration, cutover and retirement remain open or unauthorized. |
...
current-truth evidence, and WP3E is committed in HEAD
`e04f4a695d983c71a52f48d0c3c26ca605bb4402`. WP3F adds read-only DDL-readiness
and privacy-safe classification evidence: 44/44 aliases are
`POSSIBLE_DUPLICATE`, every row requires manual review, automatic promotion is
`NO`, and all ten candidate responsibilities are blocked. The TKV alignment
guard remains: internal roots, immutable versions, RLS and grants support
reconstruction but establish no TKV or verifier acceptance. Implementation,
proof implementation, DDL, data migration, caller cutover and retirement remain
unauthorized. Connection DDL still depends on a proven locationfoundation.
Authority validation continues externally and independently.

| checklist item | status | evidence / gate |
|---|---|---|
| design/contract | BLOCKED — DECISION | WP3F proves the ten candidate DDL responsibilities are not safe to implement. Exact physical columns/types/defaults, accepted-version representation, observation privacy/retention/provenance, deterministic concurrency, policies/grants/RPCs and proof matrix require separate approval. |
| existing module inventory | COMPLETE — CURRENT PROVEN | WP3F rechecks the current table, references, functions, signup/dashboard callers, PDOK observation, migration/proposal conflicts and reusable WP2A/WP2B-I patterns without modifying them. |
...
| database | BLOCKED — DECISION | `app_dossier_locations` remains mutable, dossier-bound and populated. Read-only SQL classified 44/44 aliases as `POSSIBLE_DUPLICATE`; manual review is `YES` and automatic promotion is `NO` for every row. No DDL, row mutation, mapping persistence, migration-history write, cutover or retirement is authorized. |
...
| tests | TODO | Future proof must cover the WP3E minimum scenarios after separate exact-contract and implementation authorization. Existing proofs remain reuse input or `PROVE AGAIN`; no proof script ran in WP3F. |
| SQL proof | COMPLETE — UNCOMMITTED | Explicit local read-only transactions inspected catalogs, aggregate references and privacy-safe classifications only; every transaction rolled back and no PII or alias-to-ID mapping was retained. |
| browser proof | TODO | Required only when approved customer-visible behavior is implemented. |
| documentation update | COMPLETE — UNCOMMITTED | WP3F adds the DDL-readiness audit and privacy-safe 44-row classification and updates only roadmap, TODO and append-only changelog; contracts, prior WP3 records, code and schema remain unchanged. |
| accepted by Daan | TARGET | WP3E internal location package 1–16 remains approved TARGET. WP3F is proof-only evidence and grants no physical-contract, DDL, implementation, data-migration, cutover, retirement or execution approval. |
