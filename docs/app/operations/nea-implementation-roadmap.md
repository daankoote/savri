...
Next bounded gate: obtain written Dutch corporate-law and external-verifier validation of the simple-majority representation-authority pilot brief, with register-specialist input where needed; this is not contract or schema work, and authority remains `NOT SCHEMA READY`.
...
| Current work package | Simple-majority representation-authority pilot validation brief is DRAFT — PENDING LEGAL AND VERIFIER VALIDATION; representation authority remains NOT SCHEMA READY |
| Last completed work package | WP2B-II — representation-authority readiness and domain-decision audit — DOCS ONLY |
| Next executable work package | Written legal/verifier validation of the pilot brief and Daan's later decision on the bounded contract; no automatic schema, migration, proof, runtime, or UI work |
| Current blockers | WP2A/WP2B-I versions remain absent from local migration history. Pilot authority basis/evidence, self-action, individual organization/VvE authority, optional direct power of attorney, scope, freshness, temporal/revocation reliance and reviewer/four-eyes rules require written validation. Complex cases remain post-MVP and blocked/manual |
...
| Evidence reference | WP2B-I commit `5a5265adc516e8198cc25757654920d4aa3316bd`; WP2B-II audit commit `14fe70a175232f30a525e4d139ca5012dc81a4a3`; `proofs/wp2b-i-case-party-role-foundation.md`; `operations/wp2b-ii-representation-authority-readiness-audit.md`; draft `legal/representation-authority-pilot-validation-brief.md`; official TKV snapshot and mapped requirements |
