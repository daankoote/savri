...
Frontend is still not connected. A pure frontend payload mapper now exists and is locally proven, but it does not call the endpoint or navigate to the dashboard.
