-- ENVAL locked/unpaid reminder flow conflict fix
-- Date: 2026-05-15
--
-- Purpose:
-- - Fix PL/pgSQL ambiguity in ON CONFLICT (dossier_id, reminder_day).
-- - In RETURNS TABLE functions, output columns are variables.
-- - Therefore ON CONFLICT must target a named constraint.
