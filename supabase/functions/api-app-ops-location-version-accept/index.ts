...
export const ACTIONS = Object.freeze({
  prepare: "app_ops_location_accept_prepare_v1",
  review: "app_ops_location_accept_review_v1",
  execute: "app_ops_location_accept_execute_v1",
});
...
function businessPayload(input: JsonObject): JsonObject | null {
  ...
  if (
    !caseId || !locationId || !observationId || !validFrom || !acceptedAt ||
    !decisionRef || (input.valid_to !== null && !validTo)
  ) return null;
  return {
    case_id: caseId,
