...
serve(async (req) => {
  ...
  const latestCompletedRun = await getLatestCompletedAnalysisRun(SB, dossier_id);
  ...
  const analysis_run = latestCompletedRun
  ? {
      run_id: latestCompletedRun.id,
      trigger_type: latestCompletedRun.trigger_type || null,
      requested_by_actor_type: latestCompletedRun.requested_by_actor_type || null,
      requested_by_actor_ref: latestCompletedRun.requested_by_actor_ref || null,
      request_source: latestCompletedRun.request_source || null,
      mode: latestCompletedRun.mode || null,
      status: latestCompletedRun.status || null,
      method_code: latestCompletedRun.method_code || null,
      method_version: latestCompletedRun.method_version || null,
      worker_runtime: latestCompletedRun.worker_runtime || null,
      worker_version: latestCompletedRun.worker_version || null,
      trigger_reason: latestCompletedRun.trigger_reason || null,
      document_count: latestCompletedRun.document_count ?? null,
      supported_document_count: latestCompletedRun.supported_document_count ?? null,
      started_at: latestCompletedRun.started_at || null,
      finished_at: latestCompletedRun.finished_at || null,
      error_code: latestCompletedRun.error_code || null,
      error_message: latestCompletedRun.error_message || null,
      created_at: latestCompletedRun.created_at || null,
      updated_at: latestCompletedRun.updated_at || null,
    }
  : null;
  ...
  ? {
      run_id: analysis_summary_latest.run_id || null,
