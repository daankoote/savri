...
EXPECTED_BY_IMAGE: Dict[str, Dict[str, Any]] = {
    "invoice_daan_camera_bad_01.jpg": {
    ...
    "invoice_daan_camera_bad_02.jpg": {
        "customer_name": "Daan Koote",
        "address_line": "Geulstraat 28-1H",
        "postcode_line": "1078LA",
        "city_line": "Amsterdam",
    ...
    "invoice_daan_camera_bad_03.png": {
        "customer_name": "Daan Koote",
        "address_line": "Geulstraat 28-1H",
        "postcode_line": "1078LA",
        "city_line": "Amsterdam",
    ...
    "invoice_daan_screenshot_good_01.jpg": {
        "customer_name": "Daan Koote",
        "address_line": "Geulstraat 28-1H",
        "postcode_line": "1078LA",
        "city_line": "Amsterdam",
    ...
    "invoice_daan_synthetic_good_04jpg.jpg": {
        "customer_name": "Daan Koote",
        "address_line": "Geulstraat 28-1H",
        "postcode_line": "1078LA",
        "city_line": "Amsterdam",
    ...
    "invoice_paul_camera_bad_01.jpg": {
    ...
    "invoice_paul_camera_bad_02.jpg": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_camera_bad_03.png": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_camera_good_01.jpg": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_pdf_03 brand_model_variant_01_p01.jpg": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_pdf_05 brand_model_variant_03_p01.jpg": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_pdf_06 MID_wrong_01_p01.jpg": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_pdf_07_brand_wrong_01_p01.jpg": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_pdf_08_model_wrong_01_p01.jpg": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_pdf_09_address_wrong_01_p01.jpg": {
        "customer_name": "Paul Koote",
    ...
    "invoice_paul_pdf_10_serial_wrong_01_p01.jpg": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_pdf_11_all_correct_01_p01.jpg": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_pdf_12_chaos_01_p01.jpg": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_pdf_13 multi-page 01_p01.jpg": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_pdf_13 multi-page 01_p02.jpg": {
        "customer_name": None,
        "address_line": None,
        "postcode_line": None,
        "city_line": None,
    ...
    "invoice_paul_pdf_13 multi-page 01_p03.jpg": {
        "customer_name": None,
        "address_line": None,
        "postcode_line": None,
        "city_line": None,
    ...
    "invoice_paul_pdf_14_multi-page_+_chaos 01_p01.jpg": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_pdf_14_multi-page_+_chaos 01_p02.jpg": {
        "customer_name": None,
        "address_line": None,
        "postcode_line": None,
        "city_line": None,
    ...
    "invoice_paul_pdf_14_multi-page_+_chaos 01_p03.jpg": {
        "customer_name": None,
        "address_line": None,
        "postcode_line": None,
        "city_line": None,
    ...
    "invoice_paul_screenshot_good_01.jpg": {
        "customer_name": "Paul Koote",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
    ...
    "invoice_paul_synthetic_good_02.jpg": {
        ...
        "serial_number": "0987654321",
        "mid_number": "M0987654321",
        "brand": "Coastline Charge",
        "model": "Beach Model D",
    },

    "rare invoices/invoice_test_fail_crop_300x400.jpg": {
        "customer_name": "CROP TEST — moet client-side falen",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
        "serial_number": "1234567890",
        "mid_number": "1234567890",
        "brand": None,
        "model": None,
    },
    "rare invoices/invoice_test_fail_lowheight_1200x500.jpg": {
        "customer_name": "FACE MUR oct client-side falen",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
        "serial_number": "1234567890",
        "mid_number": "M1234567890",
        "brand": None,
        "model": None,
    },
    "rare invoices/invoice_test_fail_narrow_500x1200.jpg": {
        "customer_name": "SMALLE SCREENSHOT — moet client-side falen",
        "address_line": "Kostverlorenstraat 65",
        "postcode_line": "2042PC",
        "city_line": "Zandvoort",
        "serial_number": None,
...
def build_compare_report(batch_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for result in batch_data.get("results", []):
        ...
        expected_fields = EXPECTED_BY_IMAGE.get(image_key)
        ...
        if expected_fields is None:
            report_results.append({
                ...
                "overall_reason": "no_expected_fixture_for_image",
                "field_results": [],
            })
            continue
    ...
    return {
        "ok": True,
        "compare_version": "invoice_compare_v2",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compare expected invoice OCR results against batch OCR output")
    parser.add_argument(
        "--batch-json",
        default="scripts/analysis_worker/output/invoice_image_batch_results.json",
        help="Path to invoice image batch results JSON",
    )
    parser.add_argument(
        "--out",
        default="scripts/analysis_worker/output/invoice_image_compare_results.json",
