...
const CHECK_LIST = [
  ...
  check({
    ...
    mutatesState: true,
    expectedDurationMs: 15_000,
    expectedMarker: "EVIDENCE_FACT_REVIEW_SERVED_Q01_Q18=PASS",
  }),
  check({
  ...
  check({
    ...
    minimumMode: "TARGETED",
    expectedDurationMs: 1_500,
    expectedMarker: "CUSTOMER_CORRECTION_HANDOFF_V2_Q01_Q07=PASS",
  }),
  check({
    ...
    expectedDurationMs: 2_000,
    expectedMarker: "CUSTOMER_CORRECTION_HANDOFF_V2_PILOT_LOCAL_READ=PASS",
  }),
  check({
  ...
  check({
    ...
    minimumMode: "TARGETED",
    expectedDurationMs: 1_500,
    expectedMarker: "CUSTOMER_CORRECTION_HANDOFF_UI_Q01_Q13=PASS",
  }),
  check({
